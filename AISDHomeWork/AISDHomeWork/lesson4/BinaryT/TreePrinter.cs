...
{
    //Реализацию вывода дерева подглядел в гугле, но получилось очень круто)
        ...
        public static void Print(Node root, int topMargin = 2, int leftMargin = 2)
        {
            ...
            for (int level = 0; next != null; level++)
            {
                ...
                if (level > 0)
                {
                    ...
                    if (next == item.Parent.Node._leftNode)
                    {
                ...
                next = next._leftNode ?? next._rightNode;
                for (; next == null; item = item.Parent)
                {
                    ...
                    if (item == item.Parent.Left)
                    {
                        ...
                        next = item.Parent.Node._rightNode;
                    }
                    else
                    {
